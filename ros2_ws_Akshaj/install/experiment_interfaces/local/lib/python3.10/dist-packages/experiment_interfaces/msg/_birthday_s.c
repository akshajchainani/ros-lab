...
bool experiment_interfaces__msg__birthday__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("experiment_interfaces.msg._birthday.Birthday", full_classname_dest, 44) == 0);
  }
  experiment_interfaces__msg__Birthday * ros_message = _ros_message;
  {  // year
...
{
  /* NOTE(esteve): Call constructor of Birthday */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("experiment_interfaces.msg._birthday");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Birthday");
