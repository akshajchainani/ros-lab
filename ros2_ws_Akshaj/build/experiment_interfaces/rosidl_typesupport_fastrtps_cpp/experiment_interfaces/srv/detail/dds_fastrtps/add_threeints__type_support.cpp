...
#include "experiment_interfaces/srv/detail/add_threeints__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const experiment_interfaces::srv::AddThreeints_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  experiment_interfaces::srv::AddThreeints_Request & ros_message)
{
  // Member: a
  cdr >> ros_message.a;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = experiment_interfaces::srv::AddThreeints_Request;
    is_plain =
      (
      offsetof(DataType, c) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const experiment_interfaces::srv::AddThreeints_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<experiment_interfaces::srv::AddThreeints_Request *>(
    untyped_ros_message);
...
{
  return &experiment_interfaces::srv::typesupport_fastrtps_cpp::_AddThreeints_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, experiment_interfaces, srv, AddThreeints_Request)() {
  return &experiment_interfaces::srv::typesupport_fastrtps_cpp::_AddThreeints_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_experiment_interfaces
cdr_serialize(
  const experiment_interfaces::srv::AddThreeints_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: sum
  cdr << ros_message.sum;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  experiment_interfaces::srv::AddThreeints_Response & ros_message)
{
  // Member: sum
  cdr >> ros_message.sum;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = experiment_interfaces::srv::AddThreeints_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const experiment_interfaces::srv::AddThreeints_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<experiment_interfaces::srv::AddThreeints_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &experiment_interfaces::srv::typesupport_fastrtps_cpp::_AddThreeints_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, experiment_interfaces, srv, AddThreeints_Response)() {
  return &experiment_interfaces::srv::typesupport_fastrtps_cpp::_AddThreeints_Response__handle;
}
...
{
  return &experiment_interfaces::srv::typesupport_fastrtps_cpp::_AddThreeints__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, experiment_interfaces, srv, AddThreeints)() {
  return &experiment_interfaces::srv::typesupport_fastrtps_cpp::_AddThreeints__handle;
}
